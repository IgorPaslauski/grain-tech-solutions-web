  ...
  return (
    <section className="relative h-screen flex items-center">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://images.unsplash.com/photo-1528825871115-3581a5387919?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80')",
        }}
      >
